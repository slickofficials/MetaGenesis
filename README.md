...
This project is Benga’s (Oluwagbenga Adesanga) solo grind – fusing Computer Science foundations, IBM mainframe badges (z/OS, COBOL, JCL, DB2), and Python bots (CCXT trading, Flask dashboards) into a future-proof tool for fintech relos. Day 1-3 posted on LinkedIn; join the build!
Overview
